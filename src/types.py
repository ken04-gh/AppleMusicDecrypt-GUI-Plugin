...
@dataclass
class DownloadPathContext:
    """Folder layout for one download session (song/album/playlist/artist/library)."""
    kind: str  # song | album | playlist | library_album | library_song
    container_name: str
