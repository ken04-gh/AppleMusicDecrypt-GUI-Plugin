        ...
        for raw_url in raw_urls:
            ...
            match url.type:
                ...
                case URLType.LibraryPlaylist:
                    safely_create_task(
                        self.ripper.rip_library_playlist(url, codec, Flags(force_save=force_download, language=language)))
                case URLType.LibraryAlbum:
                    safely_create_task(
                        self.ripper.rip_library_album(url, codec, Flags(force_save=force_download, language=language)))
                case URLType.LibrarySong:
                    safely_create_task(
                        self.ripper.rip_library_song(url, codec, Flags(force_save=force_download, language=language)))
                case _:
